...
class LeftViewController : UIViewController, LeftMenuProtocol {
  ...
  let stasticViewController: UIViewController = {
    let stasticVC = UINavigationController(rootViewController: StasticsViewController())
    return stasticVC
  }()
  ...
  func changeViewController(_ menu: LeftMenu) {
    ...
    //case .stastics:
     // self.slideMenuController()?.changeMainViewController(self.stasticViewController, close: true)
    }
  }
}
